                ...
                <ul class="nav pull-right">
                    ...
                    <li class="dropdown" id="header_inbox_bar">
                        ...
                        <ul class="dropdown-menu extended inbox">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img src="{{ asset('public/assets/img/avatar2.jpg') }}" alt="" /></span>
								<span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img src="{{ asset('public/assets/img/avatar3.jpg') }}" alt="" /></span>
								<span class="subject">
                            ...
                            <li>
                                <a href="#">
                                    <span class="photo"><img src="{{ asset('public/assets/img/avatar1.jpg') }}" alt="" /></span>
								<span class="subject">
